...
var newline_regex = /\r\n|\n\r|\n|\r/g;
var address_regex = /^chrome:\/\/|chrome-extension:\/\/|chrome-devtools:\/\/|twitch.tv/g;
        ...
        tab_queue.forEach(function(tab){
            try {
                interface.script_injector(tab, function(){
                    ...
                    //message to send
                    {message: 'data', list: emote_manager.emote_list, tipsy: local_settings.use_tipsy, maki: local_settings.override_maki, dynamic: local_settings.replace_emotes_dynamically});
            } catch (e) {
                console.log(e);
            }
