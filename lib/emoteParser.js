...
const EMOTE_MAIN_HOSTS = {
    ...
    TEChannels: {
        name: 'TE',
        baseURL: 'http://twitchemotes.com/api_cache/v2/subscriber.json',
            ...
            for (var key in channels) {
                if (channels.hasOwnProperty(key)) {
                    var currentChannel = channels[key].id,
                        ...
                        problemEmote = OLD_CHANNELS.indexOf(currentChannel) !== -1,
                        parsedCollection = {
                            host: this.name,
...
const EMOTE_CHANNEL_HOSTS = {
    ...
    TSChannels: {
        ...
        getBaseURL: function(channelName) {
            return this.baseURL.replace('TYPE', channelName);
        },
