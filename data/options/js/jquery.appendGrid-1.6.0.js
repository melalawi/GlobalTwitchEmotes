...
(function ($) {
    ...
    var _defaultColumnOptions = {
        ...
        type: 'text',
        //Hint: if type is 'text', display a placeholder
        hint: '',
        // Name of column.
        name: null,
        // Default value.
    ...
    var _methods = {
        init: function (options) {
            var target = this;
            if (target.length > 0) {
                // Check mandatory parameters included
        ...
        for (var z = 0; z < numOfRow; z++) {
            ...
            for (var y = 0; y < settings.columns.length; y++) {
                ...
                if (settings.columns[y].type == 'custom') {
                    ...
                    ctrl.name = ctrlName;
                    tbCell.appendChild(ctrl);
                    //GTE EDIT: If a hint is provided, apply it as a placeholder
                    if (settings.columns[y].hint) {
                        $(ctrl).attr("placeholder", settings.columns[y].hint);
                    }
